...
for (const [name, value] of [
  ...
  ['signature-wordmark-minimum-width', get('signature.wordmark.minimumWidth')],
  ['signature-wordmark-clear-space', get('signature.wordmark.clearSpace')],
  ['signature-symbol-minimum-box', get('signature.symbol.minimumBox')],
  ['signature-symbol-preferred-minimum-box', get('signature.symbol.preferredMinimumBox')],
  ['signature-symbol-clear-space', get('signature.symbol.clearSpace')],
  ['signature-symbol-gap', get('signature.symbol.gap')],
  ['signature-symbol-primary-color', get('signature.symbol.primaryColor')],
  ['signature-symbol-active-module-color', get('signature.symbol.activeModuleColor')],
  ['signature-accent-underline-thickness', get('signature.accentUnderline.thickness')],
  ['signature-accent-underline-offset', get('signature.accentUnderline.offset')],
  ['signature-accent-underline-line-color', get('signature.accentUnderline.lineColor')],
  ['signature-accent-underline-terminal-color', get('signature.accentUnderline.terminalColor')],
  ['signature-utility-mark-minimum-box', get('signature.symbol.minimumBox')],
  ['signature-utility-mark-clear-space', get('signature.symbol.clearSpace')],
  ['signature-marker-size', get('space.8')],
  ['signature-marker-gap', get('signature.symbol.gap')],
  ['signature-marker-color', get('signature.symbol.activeModuleColor')],
]) add(lines, name, value);
