...
- Fonte: `08_leo_ferraz_typing_on_laptop_202608271724.mp4`
- Headline principal: `Hipótese sobre presença visual consistente`
- Headline de transição: `O complemento está na legenda`
- Legenda:
...
- Headline principal: `A referência é real; a cena é gerada`
- Headline de transição: `O processo está na legenda`
- Legenda:
...
- Fonte: `03_leo_ferraz_typing_on_laptop_202608271724.mp4`
- Headline principal: `Isso não foi um clique`
- Headline de transição: `Fotos, créditos e tentativas estão na legenda`
- Legenda:
...
- Headline principal: `Seu conteúdo depende de você aparecer?`
- Headline de transição: `A pergunta completa está na legenda`
- Legenda:
...
- Headline principal: `Você tem algo a dizer, mas não publica?`
- Headline de transição: `O gargalo está na legenda`
- Legenda:
...
- Fonte: `07_leo_ferraz_typing_on_laptop_202608271724.mp4`
- Headline principal: `Atenção não é uma oferta`
- Headline de transição: `Veja o próximo passo na legenda`
- Legenda:
...
- Headline principal: `Como um fundador usaria isso?`
- Headline de transição: `Um exemplo está na legenda`
- Legenda:
...
- Fonte: `04_leo_ferraz_typing_on_laptop_202608271724.mp4`
- Headline principal: `Você usaria um Reel sem fala?`
- Headline de transição: `Responda depois de ler a legenda`
- Legenda:
...
- Headline principal: `Estou testando este formato com quem já vende`
- Headline de transição: `Se esse é seu gargalo, envie PILOTO`
- Legenda:
...
- Usar somente um CTA por peça.
- Não usar `comente para receber um material` enquanto não houver material real para entregar.
...
- Não usar hashtags pessoais, de autoria ou do nome do fundador como estratégia principal de aquisição nesta série.
- Priorizar hashtags de segmento, problema, contexto de conteúdo e intenção comercial do ICP.
